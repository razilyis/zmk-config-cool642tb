...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_STUDIO_TRANSPORT_UART_RX_STACK_SIZE, 512);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_INPUT_PROCESSOR_TRANSFORM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_INPUT_PROCESSOR_SCALER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_INPUT_PROCESSOR_CODE_MAPPER, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BEHAVIOR_SENSOR_ROTATE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHIELD_COOL642TB_R, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_PIXART_PMW3610_ALT_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_BEHAVIOR_SENSOR_ROTATE_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_INPUT_PROCESSOR_CODE_MAPPER_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_INPUT_PROCESSOR_SCALER_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_INPUT_PROCESSOR_TRANSFORM_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_ALT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_INPUT_PMW3610_INIT_PRIORITY, 90);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_ALT_INIT_POWER_UP_EXTRA_DELAY_MS, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_ALT_REPORT_INTERVAL_MIN, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_ALT_SMART_ALGORITHM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_ALT_RUN_DOWNSHIFT_TIME_MS, 128);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_ALT_REST1_DOWNSHIFT_TIME_MS, 5000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_ALT_REST2_DOWNSHIFT_TIME_MS, 17000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_ALT_REST1_SAMPLE_TIME_MS, 40);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_ALT_REST2_SAMPLE_TIME_MS, 100);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_ALT_REST3_SAMPLE_TIME_MS, 500);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_ZMK_PMW3610_DRIVER_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_ZMK_RGBLED_WIDGET_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_STATUS_ADVERTISEMENT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_EXT_ADV_MAX_ADV_SET, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_STATUS_ADV_INTERVAL_MS, 1000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_STATUS_ADV_KEYBOARD_NAME, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PROSPECTOR_CHANNEL, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_STATUS_ADV_ACTIVITY_BASED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_STATUS_ADV_ACTIVE_INTERVAL_MS, 200);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_STATUS_ADV_IDLE_INTERVAL_MS, 30000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_STATUS_ADV_ACTIVITY_TIMEOUT_MS, 5000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_STATUS_ADV_CENTRAL_SIDE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_STATUS_ADV_HALF_PERIPHERAL, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_STATUS_ADV_AUX1_PERIPHERAL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_STATUS_ADV_AUX2_PERIPHERAL, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PROSPECTOR_BRIGHTNESS_FADE_STEPS, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_STATUS_ADV_WPM_WINDOW_SECONDS, 30);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_STATUS_ADV_WPM_DECAY_TIMEOUT_SECONDS, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_STATUS_ADV_WMP_DECAY_TIMEOUT_SECONDS, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_PROSPECTOR_ZMK_MODULE_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_RX_COUNT_EXTRA, 6);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CONN_FRAG_COUNT, 6);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ADV_AUX_SET, 2);
