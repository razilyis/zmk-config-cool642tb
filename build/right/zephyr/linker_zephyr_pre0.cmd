...
zmk_behavior_local_id_map_area : ALIGN_WITH_INPUT { _zmk_behavior_local_id_map_list_start = .; KEEP(*(SORT_BY_NAME(._zmk_behavior_local_id_map.static.*))); _zmk_behavior_local_id_map_list_end = .; } > RAM AT > FLASH
zmk_rpc_subsystem_area : ALIGN_WITH_INPUT { _zmk_rpc_subsystem_list_start = .; KEEP(*(SORT_BY_NAME(._zmk_rpc_subsystem.static.*))); _zmk_rpc_subsystem_list_end = .; } > RAM AT > FLASH
    __data_region_end = .;
